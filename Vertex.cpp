...
Vertex& Vertex::operator=(const Vertex& other) {
    if (this != &other) { // Self-assignment check
        // Copy data members
        this->numIndex = other.numIndex;
        this->building = other.building; // Shallow copy, assuming ownership is managed elsewhere
        this->tileList = other.tileList;
        this->pathsList = other.pathsList;
        this->neighborsList = other.neighborsList;
    }
    return *this;
}
